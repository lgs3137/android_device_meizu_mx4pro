...
void _ZN7android13SensorManagerC1Ev(void *sensorMgr)
{
    ...
    _ZN7android8String16C1EPKc(&string, "camera.m76");
...
{
    ALOGI("mx4pro camera interposition library loaded. Your camera should work in M now.");
}
...
{
    ALOGI("mx4pro camera interposition library unloading. Goodbye...");
